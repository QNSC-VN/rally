  ...
  return (
    <div className="flex flex-col flex-1 overflow-hidden">
      ...
      <div className="flex flex-col flex-1 overflow-auto" style={{ backgroundColor: BRAND.surface }}>
        ...
        <div
          className="sticky top-0 z-10 flex items-center h-[34px] px-3 select-none text-[11px] font-bold"
          style={{
        ...
        {totals && (
          ...
          >
            ...
            <div className="flex-1 min-w-[180px]" style={colStyles.name}>Totals</div>
  ...
  return (
    <div>
      ...
      >
        ...
        {/* Owner info */}
        <div className="flex items-center gap-2 flex-1 min-w-[180px]" style={colStyles.name}>
          <Avatar name={group.owner.displayName} size={20} />
          <span className="text-[11px] font-semibold truncate" style={{ color: BRAND.textPrimary }}>
            {group.owner.displayName}
          </span>
          <span className="text-[10px] shrink-0" style={{ color: BRAND.textMuted }}>
            ({group.taskCount} tasks)
          </span>
          {/* Progress bar */}
          <div
            className="w-16 h-1.5 rounded-full overflow-hidden ml-2 shrink-0"
        ...
        <div className="shrink-0 text-right" style={colStyles.capacity} onClick={(e) => e.stopPropagation()}>
          <InlineEditableCell
            value={String(group.capacityHours)}
            canEdit={canEdit}
            onCommit={commitCapacity}
            trigger="dblclick"
            className="text-[11px] font-mono tabular-nums hover:underline"
        ...
        <div className="shrink-0 text-right text-[11px] font-mono tabular-nums" style={{ ...colStyles.estimate, color: BRAND.textSecondary }}>
          {group.estimateHours}
        </div>
        <div className="shrink-0 text-right text-[11px] font-mono tabular-nums" style={{ ...colStyles.todo, color: BRAND.textSecondary }}>
          {group.todoHours}
        </div>
        <div className="shrink-0 text-right text-[11px] font-mono tabular-nums" style={{ ...colStyles.actuals, color: BRAND.textSecondary }}>
          {group.actualHours}
        </div>
        <div className="shrink-0" style={colStyles.owner} />
      </div>
...
function TaskRow({
  ...
  return (
    <div
      className="flex items-center h-[34px] px-3 text-[11px] bg-white hover:bg-[#f1f6fc] transition-colors duration-100"
    ...
    >
      ...
      <div className="shrink-0 font-mono text-[10px] px-2" style={{ ...colStyles.rank, color: BRAND.textSecondary }}>
        {idx + 1}
      </div>
      {/* ID (P3-TS-FR-023) */}
      <button
        className="shrink-0 cursor-pointer text-left font-mono truncate hover:underline px-2"
      ...
      <div className="flex-1 min-w-[180px] px-2" style={colStyles.name} onClick={(e) => e.stopPropagation()}>
        <InlineEditableCell
          value={task.title}
          canEdit={canEdit}
      ...
      <div className="flex shrink-0 items-center gap-1 truncate px-2" style={{ ...colStyles.workProduct, color: BRAND.textSecondary }}>
      ...
      <div className="shrink-0 truncate px-2" style={{ ...colStyles.release, color: BRAND.textSecondary }}>
        {task.release?.name ?? ''}
      </div>
      {/* State (P3-TS-FR-021 — inline editable) */}
      <div className="shrink-0 px-2" style={colStyles.state} onClick={(e) => e.stopPropagation()}>
        {canEdit ? (
          <div className="flex border rounded overflow-hidden" style={{ borderColor: BRAND.borderSubtle, height: 20 }}>
      ...
      <div className="shrink-0 text-right px-2" style={colStyles.estimate} onClick={(e) => e.stopPropagation()}>
        <InlineEditableCell
      ...
      <div className="shrink-0 text-right px-2" style={colStyles.todo} onClick={(e) => e.stopPropagation()}>
        <InlineEditableCell
      ...
      <div className="shrink-0 text-right px-2" style={colStyles.actuals} onClick={(e) => e.stopPropagation()}>
        <InlineEditableCell
      ...
      <div className="shrink-0 truncate text-[11px] px-2" style={colStyles.owner} onClick={(e) => e.stopPropagation()}>
        {editingOwner && canEdit ? (
          <select
            ...
            className="w-full text-[11px] rounded focus:outline-none"
