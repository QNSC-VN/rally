...
import { useAttachments, useUploadAttachment, useDeleteAttachment } from '@/features/collaboration/api'
    ...
    <section className="bg-white rounded overflow-hidden" style={{ border: '1px solid #dde2ea' }}>
      ...
      <div className="divide-y" style={{ borderColor: '#f1f5f9' }}>
        ...
        {attachments.map((a) => {
          ...
          const downloadUrl = a.downloadPath ?? `/v1/work-items/${a.workItemId}/attachments/${a.id}/download`
          return (
            <div
              key={a.id}
      ...
      {!readOnly && (
        <div
          ...
          style={{
            border: `2px dashed ${dragging ? '#2558a6' : '#d1d5db'}`,
        ...
        >
          ...
          >
            <Upload size={18} style={{ color: dragging ? '#2558a6' : '#94a3b8' }} />
            <span className="text-[11px]" style={{ color: dragging ? '#2558a6' : '#6b7280' }}>
      ...
      {sizeError && (
        <div
          className="mx-3 mb-3 flex items-center justify-between gap-2 px-3 py-2 rounded text-[11px]"
