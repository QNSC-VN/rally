...
const MAX_HARDCODED_TEXT = 32 // capitalized JSX text nodes in consumer layers (RBAC migration added Settings tabs + access surface + permission model with English-first copy; i18n deferred)
