...
export const MilestoneResponseSchema = z.object({
  ...
  targetStartDate: z.string().nullable().describe('YYYY-MM-DD, manually set or derived from linked releases'),
  targetEndDate: z.string().nullable().describe('YYYY-MM-DD, manually set or derived from linked releases'),
  releaseIds: z.array(z.string().uuid()),
  projectIds: z.array(z.string().uuid()).optional(),
  teamIds: z.array(z.string().uuid()).optional(),
  progress: MilestoneProgressSchema.optional().describe('Work-item completion across linked releases'),
